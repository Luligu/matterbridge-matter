/**
 * @file src/module.ts
 * @description This file contains the class MatterPlatform.
 * @author Luca Liguori
 * @created 2024-08-28
 * @version 1.0.0
 * @license Apache-2.0
 ...
 * @returns {MatterPlatform} - An instance of the MatterPlatform. This is the main interface for interacting with the platform system.
 */
export default function initializePlugin(matterbridge: PlatformMatterbridge, log: AnsiLogger, config: PlatformConfig): MatterPlatform {
  return new MatterPlatform(matterbridge, log, config);
}
